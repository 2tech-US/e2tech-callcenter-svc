...
import {validateStringField,validateUserPassword,validateUserName} from "./utils/validate.js";
...
$("#signup").on("click", async () => {
    ...
    const isValidUserEmail =  validateStringField("useremail","email-error",7,15);
